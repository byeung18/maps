...
#define PI				3.141592653589793238462643383279902
...
static const vector<t_color> predef_colors = {
    ...
    t_color(0x32, 0xCD, 0x32), // "limegreen"
        // Added a couple of new colours just for the map
    t_color(174, 174, 174), // "smallroad" small road color
    t_color(247, 247, 247), // "mapbase" colour
    t_color(210, 215, 211), // "background"
    t_color(0xA1, 0x8E, 0xAD), //"mainroad"
    t_color(241, 196, 15), // "highway"
    t_color(244, 208, 63), // "beach"
    t_color(137, 196, 244), // "water"
    t_color(135, 211, 124), // "nature"
    t_color(52, 152, 219), // "route"
    t_color(242, 38, 19), // "stop"
    t_color(26,188,156) // "start"
};
