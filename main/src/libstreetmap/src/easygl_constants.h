...
enum color_types {
    ...
    // These colours are for the map thing
    SMALLROAD, 
    MAPBASE, // the base colour for the map
    BACKGROUND, // light grey colours for background
    MAINROAD, // light pink colour for major streets
    HIGHWAY, // strong yellow colour for highways
    BEACH, // light yellow colour for beaches
    WATER, // colour of water, light blue
    NATURE, // light greenish colour
    ROUTE, // brighter blue colour, to be used in m3 and m4
    STOP, // bright red colour, end of route marker
    START, // bright turquoise colour, start of route marker
    NUM_COLOR
};
